...
public class BlueGainCommand : IStaticCommand
{
    public BlueGainCommand(IGamepad gamepad) : base(gamepad)
    {
    }

    public override string CommandName => "Blue gain";
    ...
    public override void Execute(int value)
    {
        ...
        if (Enum.IsDefined((GainDir)byteVal))
            Gamepad.SelectedCamera?.AdjustBlueGain((GainDir)byteVal);
        else
